...
@Component({
            ...
            <div class="hero-content">
              ...
              <div class="hero-actions">
                ...
                <div class="action-buttons">
                  ...
                  <button class="btn-enroll-now" (click)="enrollNow()">Enroll Now</button>
                </div>
              </div>
            </div>
            ...
            <div class="content-sidebar">
              <div class="sidebar-card">
                ...
                <div class="sidebar-actions">
                  @if (isInCart()) {
                    <button class="btn btn-added btn-full" disabled>
                      <i class="ti ti-check"></i>
                      Added to Cart
                    </button>
                  } @else {
                    <button class="btn btn-cart btn-full" (click)="addToCart()">
                      <i class="ti ti-shopping-cart"></i>
                      Add to Panier
                    </button>
                  }
                  <button class="btn-enroll-full" (click)="enrollNow()">Enroll Now - {{ course.price }}</button>
                </div>
              </div>
            </div>
          </div>
  ...
  styles: [`
    ...
    .sidebar-actions { margin-top: 24px; display: flex; flex-direction: column; gap: 12px; }
...
export class ClientCourseDetailsComponent implements OnInit {
  ...
  enrollNow(): void {
    if (this.course) {
      // Navigate to payment page with single course
      window.location.href = `/payment?courseId=${this.course.id}&courseTitle=${encodeURIComponent(this.course.title)}&coursePrice=${this.course.price}`;
    }
  }
}
